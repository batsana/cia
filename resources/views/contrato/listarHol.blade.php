                     ...
                     {{--    <td>{{$fab->campanha}}</td> --}}
                       ...
                       <td> 
                          ...
                          {{-- <button type="button" href="{{ url('/contrato/'.$fab->id.'/edit')}}" class="btn btn-info" data-toggle="modal" data-target="#myModaltwo">Atualizar</button> 
                           ...
                           {{--   <button data-prim="{{$fab->id}}" type="button"  class="button-alt grayb">Homologar</button>  --}}

               <a href="/edicaocontrato/{{ $fab->id }}" ><button  class="button-alt grayb">Homologar</button></a>


                             <button data-prim="{{$fab->id}}" type="button"  class="button-alt refuse">Recusar</button>

                        {{--     <a href="/contrs/{{$fab->id}}" >
                              <button  class="button-alt refuse">Recusar</button> </a> --}}
                       </td>
