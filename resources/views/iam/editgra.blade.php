...
<h1>Actualizar Dados da Gráfica</h1>
         <div class="mb40" style="display: block;"></div>               
        <form method="post" action="{{ url('/grafica/'.$ent->id)}}">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">Nome da Fabrica</label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" value="{{$user->name}}" id="nome" name="name" class="form-control input-sm" placeholder="Nome da Gráfica">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-example-int form-horizental mg-t-15">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">Endereco</label>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" value="{{$ent->endereco}}" name="endereco" class="form-control input-sm" placeholder="Endereço">
                                        </div>
                                    </div>
                                </div>
                            </div>
